...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
  ...
  /**
   * Create a new LinkedCaseInsensitiveMap that stores case-insensitive keys according to the default Locale (by default
   * in lower case).
   *
  ...
  /**
   * Create a new LinkedCaseInsensitiveMap that stores case-insensitive keys according to the given Locale (in lower
   * case).
   *
   * @param locale
  ...
  /**
   * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with an initial capacity that can
   * accommodate the specified number of elements without any immediate resize/rehash operations to be expected, storing
  ...
  public boolean equals(@Nullable Object other) {
    if (!(other instanceof LinkedCaseInsensitiveMap<?>)) {
      return false;
    }
