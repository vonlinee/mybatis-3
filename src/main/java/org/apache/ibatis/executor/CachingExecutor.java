...
public class CachingExecutor implements Executor {
  ...
  public int update(MapperUpdate update) throws SQLException {
    flushCacheIfRequired(update.getMappedStatement());
  ...
  @Override
  public Object createCacheKey(MappedStatement ms, Object parameterObject, RowBounds rowBounds, BoundSql boundSql) {
