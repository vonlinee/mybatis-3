...
public class MethodDelegationSqlProvider implements SqlProvider {
  ...
  public MethodDelegationSqlProvider(Configuration configuration, Annotation provider, Class<?> mapperType,
      Method mapperMethod, Class<?> providerType) {
  ...
  public String provideSql(ProviderContext providerContext) {
    final Object parameterObject = providerContext.getParameterObject();
    try {
      String sql;
