...
public class DefaultReflectorFactory implements ReflectorFactory {
   ...
   */
  private static class ReflectorImpl implements Reflector {
    ...
    private final Map<String, Map.Entry<Type, Class<?>>> setTypes = new HashMap<>();
    private final Map<String, Map.Entry<Type, Class<?>>> getTypes = new HashMap<>();
    private Constructor<?> defaultConstructor;

    private final LinkedCaseInsensitiveMap<String> caseInsensitivePropertyMap = new LinkedCaseInsensitiveMap<>();

    private static final Map.Entry<Type, Class<?>> nullEntry = new AbstractMap.SimpleImmutableEntry<>(null, null);

    public ReflectorImpl(Type type) {
      this.type = type;
    ...
    private void addMethodConflict(Map<String, List<Method>> conflictingMethods, String name, Method method) {
      if (ReflectionUtils.isPropertyNameValid(name)) {
    ...
    private void addSetField(Field field) {
      if (ReflectionUtils.isPropertyNameValid(field.getName())) {
     ...
     * method, instead of the simpler <code>Class.getMethods()</code>, because we want to look for private methods as
     * well.
     *
     * @param clazz
     *          The class
    ...
    @Override
    public Map.Entry<Type, Class<?>> getGenericSetterType(String propertyName) {
    ...
    @Override
    public Map.Entry<Type, Class<?>> getGenericGetterType(String propertyName) {
