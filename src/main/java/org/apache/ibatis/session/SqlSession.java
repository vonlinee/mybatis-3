...
public interface SqlSession extends Closeable {
   ...
   */
  <E> void select(String statement, Object parameter, ResultHandler<E> handler);
   ...
   *          ResultHandler that will handle each retrieved row
   */
  <E> void select(String statement, ResultHandler<E> handler);
   ...
   *          ResultHandler that will handle each retrieved row
   */
  <E> void select(String statement, Object parameter, RowBounds rowBounds, ResultHandler<E> handler);
